...
const tensesData = {
    simple_present: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + verbo (forma base) + complemento",
                negative: "Sujeito + don't/doesn't + verbo (forma base) + complemento",
                interrogative: "Do/Does + sujeito + verbo (forma base) + complemento?",
                examples: [
                    "I work every day. (Afirmativa)",
                    "I don't work on Sundays. (Negativa)", 
            ...
            rules: {
                ...
                content: [
                    "Para I, you, we, they: use o verbo na forma base",
                    "Para he, she, it: adicione -s, -es ou -ies ao verbo",
                    "Verbos terminados em -s, -sh, -ch, -x, -z: adicione -es",
                    "Verbos terminados em consoante + y: mude y para ies"
                ],
                examples: [
                    "I play → He plays",
                    "I watch → She watches", 
            ...
            keywords: {
                ...
                content: [
                    "always (sempre)", "usually (geralmente)", "often (frequentemente)",
                    "sometimes (às vezes)", "never (nunca)", "every day (todos os dias)",
                    "on Mondays (às segundas)", "in the morning (de manhã)"
                ]
            },
            usage: {
                title: "Quando usar",
    ...
    simple_past: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + verbo no passado + complemento",
                negative: "Sujeito + didn't + verbo (forma base) + complemento",
                interrogative: "Did + sujeito + verbo (forma base) + complemento?",
                examples: [
            ...
            rules: {
                title: "Regras de Conjugação",
                content: [
                    "Verbos regulares: adicione -ed à forma base",
                    "Verbos terminados em -e: adicione apenas -d",
                    "Verbos terminados em consoante + y: mude y para ied",
                    "Verbos irregulares: memorize as formas especiais"
                ],
                examples: [
    ...
    simple_future: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + will + verbo (forma base) + complemento",
                negative: "Sujeito + won't + verbo (forma base) + complemento",
                interrogative: "Will + sujeito + verbo (forma base) + complemento?",
                examples: [
    ...
    present_continuous: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + am/is/are + verbo + ing + complemento",
                negative: "Sujeito + am/is/are + not + verbo + ing + complemento",
                interrogative: "Am/Is/Are + sujeito + verbo + ing + complemento?",
                examples: [
    ...
    past_continuous: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + was/were + verbo + ing + complemento",
                negative: "Sujeito + wasn't/weren't + verbo + ing + complemento",
                interrogative: "Was/Were + sujeito + verbo + ing + complemento?",
                examples: [
    ...
    future_continuous: {
        ...
        grammar: {
            structure: {
                title: "Estrutura",
                affirmative: "Sujeito + will be + verbo + ing + complemento",
                negative: "Sujeito + won't be + verbo + ing + complemento",
                interrogative: "Will + sujeito + be + verbo + ing + complemento?",
                examples: [
